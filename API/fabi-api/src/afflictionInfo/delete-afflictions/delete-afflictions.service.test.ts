...
describe('DeleteAfflictionService', () => {
    let deleteAfflictionsService: DeleteAfflictionsService;
    ...
    beforeEach(async () => {
      ...
      deleteAfflictionsService = module.get(DeleteAfflictionsService);
    ...
    it('should be defined', () => {   //TEST 1 SHALLOW TEST SEE IF IT IS DEFINED
      expect(deleteAfflictionsService).toBeDefined();
    });
