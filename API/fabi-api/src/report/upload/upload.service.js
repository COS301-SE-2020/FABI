...
var UploadService = /** @class */ (function () {
    function UploadService(userService, reportService) {
        this.userService = userService;
        this.reportService = reportService;
        this.res = { email: "", status: 0 };
    }
    UploadService.prototype.upload = function (reqObj) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(reqObj);
                        return [4 /*yield*/, this.userService.validateToken(reqObj.email, reqObj.token).then(function (result) {
                                return result;
                            })];
                    case 1:
                        result = _a.sent();
